    ...
    class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                Config = new Menu("鐨偆鍔╂墜", "Skin Changer", true);
                ...
                var SwitchSkin = Config.AddItem(new MenuItem("keySwitch", "蹇嵎閿畖").SetValue(new KeyBind("9".ToCharArray()[0], KeyBindType.Press)));
