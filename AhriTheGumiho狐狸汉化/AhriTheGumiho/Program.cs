...
namespace AhriTheGumiho
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //key
            menu.AddSubMenu(new Menu("蹇嵎Key", "Key"));
            menu.SubMenu("Key")
                .AddItem(
            ...
            menu.SubMenu("Key")
                .AddItem(
                    new MenuItem("charmCombo", "EQ Combo").SetValue(new KeyBind("I".ToCharArray()[0],
                        KeyBindType.Toggle)));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("qHit", "Q/E 鍛戒腑鐜").SetValue(new Slider(3, 1, 4)));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("rSpeed", "浣跨敤3R").SetValue(true));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("qHit2", "Q/E 鍛戒腑鐜").SetValue(new Slider(3, 1, 4)));
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("charmHarass", "EQ").SetValue(true));
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("UseGap", "杩戣韩E").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("packet", "浣跨敤灏佸寘").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("mana", "瓒冲钃濋噺R").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("dfgCharm", "鑷姩E").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("EQ", "EQ杩炴嫑").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("smartKS", "鎶汉澶磡").SetValue(true));
            ...
            menu.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("cursor", "R绉诲姩鑼冨洿").SetValue(new Circle(false,
