...
namespace JayceTheTwerker
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Keys").AddItem(new MenuItem("shootMouse", "QE杩炴嫑").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));

            //Combo menu:
            menu.AddSubMenu(new Menu("杩炴嫑", "Combo"));
            menu.SubMenu("Combo").AddItem(new MenuItem("UseQCombo", "浣跨敤 Q").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("qSpeed", "浣跨敤E鑼冨洿").SetValue(new Slider(1600, 400, 2500)));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("UseQComboHam", "浣跨敤Hammer Q").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("UseWComboHam", "浣跨敤Hammer W").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("UseEComboHam", "浣跨敤Hammer E").SetValue(true));
            menu.SubMenu("Combo").AddItem(new MenuItem("UseRCombo", "鍒囨崲R").SetValue(true));
            
            //Harass menu:
            menu.AddSubMenu(new Menu("楠氭壈", "Harass"));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseQHarass", "浣跨敤 Q").SetValue(true));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseWHarass", "浣跨敤 W").SetValue(true));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseEHarass", "浣跨敤 E").SetValue(true));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseQHarassHam", "浣跨敤 Q Hammer").SetValue(true));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseWHarassHam", "浣跨敤 W Hammer").SetValue(true));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseEHarassHam", "浣跨敤 E Hammer").SetValue(true));
            menu.SubMenu("Harass").AddItem(new MenuItem("UseRHarass", "鍒囨崲R").SetValue(true));
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("UseGap", "浣跨敤E鎺ㄥ紑").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("packet", "浣跨敤灏佸寘").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("forceGate", "鑷姩E").SetValue(false));
            menu.SubMenu("Misc").AddItem(new MenuItem("gatePlace", "E鑼冨洿").SetValue(new Slider(300, 250, 600)));
            menu.SubMenu("Misc").AddItem(new MenuItem("UseQAlways", "浣跨敤QE").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("autoE", "QE鏁屼汉< %").SetValue(new Slider(40, 0, 100)));
            menu.SubMenu("Misc").AddItem(new MenuItem("smartKS", "鏅鸿兘浜哄ご").SetValue(true));
            ...
            menu.SubMenu("Drawings")
                .AddItem(new MenuItem("drawcds", "鏄剧ず鍐峰嵈")).SetValue(true);
            menu.SubMenu("Drawings")
