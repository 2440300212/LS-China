...
namespace VayneHunterRework
{
    class Cleanser
    {
        ...
        {
            VayneHunterRework.Menu.SubMenu("QSST").AddItem(new MenuItem("stun", "鏅曠湬").SetValue(true));
            VayneHunterRework.Menu.SubMenu("QSST").AddItem(new MenuItem("charm", "璇辨儜").SetValue(true));
