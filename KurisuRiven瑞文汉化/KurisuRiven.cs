...
namespace KurisuRiven
{
    internal class KurisuRiven
    {
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            // Draw settings
            Menu menuD = new Menu("鏄剧ず璁剧疆: ", "dsettings");
            ...
            menuD.AddItem(new MenuItem("drawp", "鏄剧ず琚姩鎬绘暟")).SetValue(true);
            menuD.AddItem(new MenuItem("drawengage", "鏁屼汉鑼冨洿")).SetValue(true);
            menuD.AddItem(new MenuItem("drawjumps", "缈诲浣嶇疆")).SetValue(true);
            ...
            menuD.AddItem(new MenuItem("dsep2", "==== Debug 璁剧疆"));
            menuD.AddItem(new MenuItem("debugdmg", "Debug 杩炴嫑浼ゅ")).SetValue(false);
            menuD.AddItem(new MenuItem("debugtrue", "Debug 鐪熷疄璺濈")).SetValue(false);
           
            config.AddSubMenu(menuD);

            Menu menuK = new Menu("蹇嵎 Key!", "demkeys");
            ...
            menuK.AddItem(new MenuItem("ksep1", "==== Debug 璁剧疆"));
            menuK.AddItem(new MenuItem("exportjump", "婕忔礊浣嶇疆")).SetValue(new KeyBind(73, KeyBindType.Press));
            config.AddSubMenu(menuK);

            // Combo Settings
            Menu menuC = new Menu("杩炴嫑璁剧疆: ", "csettings");
            menuC.AddItem(new MenuItem("csep1", "==== E 璁剧疆"));
            menuC.AddItem(new MenuItem("usevalor", "浣跨敤 E")).SetValue(true);
            menuC.AddItem(new MenuItem("valorhealth", "浣跨敤 E 鐢熷懡 %")).SetValue(new Slider(40));
            menuC.AddItem(new MenuItem("waitvalor", "E 绐佽繘 R")).SetValue(true);
            menuC.AddItem(new MenuItem("csep2", "==== R 璁剧疆"));
            menuC.AddItem(new MenuItem("useblade", "浣跨敤 R")).SetValue(true);
            menuC.AddItem(new MenuItem("bladewhen", "浣跨敤 R 妯″紡: "))
                .SetValue(new StringList(new[] { "Easykill", "Normalkill", "Hardkill" }, 2));
            menuC.AddItem(new MenuItem("checkover", "妫€娴嬪嚮鏉€")).SetValue(false);
            menuC.AddItem(new MenuItem("wslash", "鐤鹃鏂 "))
            ...
            menuC.AddItem(new MenuItem("cancelanim", "Q 鍙栨秷 绫诲瀷: "))
                .SetValue(new StringList(new[] { "Move", "Packet", "Delay" }));
            menuC.AddItem(new MenuItem("qqdelay", "Q 杩戣韩 寤惰繜 (姣): ")).SetValue(new Slider(1000, 0, 3000));
            config.AddSubMenu(menuC);

            // Extra Settings
            Menu menuO = new Menu("鍏朵粬璁剧疆: ", "osettings");
            menuO.AddItem(new MenuItem("osep2", "==== 鍏朵粬璁剧疆"));
            menuO.AddItem(new MenuItem("useignote", "浣跨敤 鐐圭噧")).SetValue(true);
            menuO.AddItem(new MenuItem("useautow", "鑷姩 W")).SetValue(true);
            menuO.AddItem(new MenuItem("autow", "鑷姩 W 鏁屼汉鏁")).SetValue(new Slider(3, 1, 5));
            menuO.AddItem(new MenuItem("osep1", "==== 鐤鹃鏂╄缃畖"));
            menuO.AddItem(new MenuItem("useautows", "鑷姩鐤鹃鏂﹟")).SetValue(true);
            menuO.AddItem(new MenuItem("autows", "浣跨敤鐤鹃鏂﹟%")).SetValue(new Slider(65, 1));
            menuO.AddItem(new MenuItem("autows2", "浣跨敤鐤鹃鏂﹟鏁屼汉鏁皘")).SetValue(new Slider(3, 2, 5));
            menuO.AddItem(new MenuItem("osep3", "==== 鎵撴柇璁剧疆"));
            menuO.AddItem(new MenuItem("interrupter", "鑷姩鎵撴柇")).SetValue(true);
            menuO.AddItem(new MenuItem("InterruptQ3", "浣跨敤 Q 鎵撴柇")).SetValue(true);
            menuO.AddItem(new MenuItem("InterruptW", "浣跨敤 W 鎵撴柇")).SetValue(true);
            config.AddSubMenu(menuO);

            // Farm/Clear Settings
            Menu menuJ = new Menu("琛ュ叺/娓呯嚎 璁剧疆: ", "jsettings");
            menuJ.AddItem(new MenuItem("jsep1", "==== 鎵撻噹璁剧疆"));
            ...
            menuJ.AddItem(new MenuItem("jsep2", "==== 琛ュ叺璁剧疆"));
            ...
            // Advance Settings
            Menu menuA = new Menu("杩涙敾璁剧疆: ", "asettings");
            menuA.AddItem(new MenuItem("asep1", "==== QA 璁剧疆"));
            menuA.AddItem(new MenuItem("autoconfig", "鎺ㄨ崘閰嶇疆")).SetValue(false);
            menuA.AddItem(new MenuItem("qcdelay", "鍙栨秷 寤舵椂: ")).SetValue(new Slider(0, 0, 1200));
            menuA.AddItem(new MenuItem("aareset", "鑷姩 閲嶇疆 寤舵椂: ")).SetValue(new Slider(0, 0, 1200));
            menuA.AddItem(new MenuItem("asep4", "==== 鍒娇鐢▅"));
            menuA.AddItem(new MenuItem("cursormode", "鍏夋爣 debug 妯″紡")).SetValue(false);
            menuA.AddItem(new MenuItem("asep2", "==== 灏忛湼鐜嬭繛閿佹眽鍖:)"));
            menuA.AddItem(new MenuItem("asep3", "kljkc13776@qq.com"));
