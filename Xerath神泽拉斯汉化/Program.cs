    ...
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("ComboActive", "蹇嵎Key!").SetValue(
                        new KeyBind(Config.Item("Orbwalk").GetValue<KeyBind>().Key, KeyBindType.Press)));

            //Misc
            Config.AddSubMenu(new Menu("R", "R"));
            Config.SubMenu("R").AddItem(new MenuItem("EnableRUsage", "鑷姩R").SetValue(true));
            Config.SubMenu("R").AddItem(new MenuItem("rMode", "妯″紡").SetValue(new StringList(new[] { "Normal", "Custom delays", "OnTap"})));
            Config.SubMenu("R").AddItem(new MenuItem("rModeKey", "蹇嵎Key").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("R").AddSubMenu(new Menu("寤惰繜", "Custom delays"));
            for (int i = 1; i <= 3; i++)
                Config.SubMenu("R").SubMenu("Custom delays").AddItem(new MenuItem("Delay"+i, "寤惰繜"+i).SetValue(new Slider(0, 1500, 0)));
            Config.SubMenu("R").AddItem(new MenuItem("PingRKillable", "娈嬭鎻愰啋").SetValue(true));
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActive", "蹇嵎Key!").SetValue(
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("FreezeActive", "灏惧垁!").SetValue(
                        new KeyBind(Config.Item("Farm").GetValue<KeyBind>().Key, KeyBindType.Press)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            //JungleFarm menu:
            Config.AddSubMenu(new Menu("鎵撻噹", "JungleFarm"));
            ...
            Config.SubMenu("JungleFarm")
                .AddItem(
                    new MenuItem("JungleFarmActive", "蹇嵎Key!").SetValue(
                        new KeyBind(Config.Item("LaneClear").GetValue<KeyBind>().Key, KeyBindType.Press)));
