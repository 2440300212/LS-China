...
namespace DevTwitch
{
    class Program
    {
        ...
        private static void InitializeMainMenu()
        {
            ...
            Config = new Menu("Dev鐦熺柅涔嬫簮-鍥惧", "DevTwitch", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("MinPassiveStackUseECombo", "浣跨敤 E 灞傛暟").SetValue(new Slider(3, 1, 6)));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("MinPassiveStackUseEHarass", "浣跨敤 E 灞傛暟").SetValue(new Slider(2, 1, 6)));
            Config.SubMenu("Harass").AddItem(new MenuItem("ManaHarass", "楠氭壈 钃濋噺 %").SetValue(new Slider(50, 1, 100)));

            //Config.AddSubMenu(new Menu("娓呯嚎", "LaneClear"));
            //Config.SubMenu("LaneClear").AddItem(new MenuItem("UseELaneClear", "浣跨敤 E").SetValue(false));
            //Config.SubMenu("LaneClear").AddItem(new MenuItem("EManaLaneClear", "浣跨敤 E 钃濋噺 %").SetValue(new Slider(50, 1, 100)));

            Config.AddSubMenu(new Menu("鎶汉澶磡", "KillSteal"));
            Config.SubMenu("KillSteal").AddItem(new MenuItem("EKillSteal", "浣跨敤 E").SetValue(true));
            Config.SubMenu("KillSteal").AddItem(new MenuItem("RKillSteal", "浣跨敤 R").SetValue(true));

            Config.AddSubMenu(new Menu("鏉傞」", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("PacketCast", "浣跨敤灏佸寘").SetValue(true));

            Config.AddSubMenu(new Menu("闃茶繎韬珅", "GapCloser"));
            //Config.SubMenu("GapCloser").AddItem(new MenuItem("QGapCloser", "浣跨敤 Q").SetValue(true));
            ...
            //Config.SubMenu("Ultimate").AddItem(new MenuItem("UseAssistedUlt", "浣跨敤澶ф嫑鍔╂墜").SetValue(true));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("RDamage", "琛€鏉℃樉绀R 浼ゅ").SetValue(true));
