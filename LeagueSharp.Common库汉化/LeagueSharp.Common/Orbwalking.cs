    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Drawings submenu */
                var drawings = new Menu("鏄剧ず閫夐」", "drawings");
                drawings.AddItem(
                    new MenuItem("AACircle", "AA 鑼冨洿").SetShared()
                        .SetValue(new Circle(true, Color.FromArgb(255, 255, 0, 255))));
                drawings.AddItem(
                    new MenuItem("AACircle2", "鏁屾柟 AA 鑼冨洿").SetShared()
                        .SetValue(new Circle(false, Color.FromArgb(255, 255, 0, 255))));
                drawings.AddItem(
                    new MenuItem("HoldZone", "淇濇寔璺濈").SetShared()
                        .SetValue(new Circle(false, Color.FromArgb(255, 255, 0, 255))));
                ...
                misc.AddItem(
                    new MenuItem("HoldPosRadius", "淇濇寔 璺濈 浣嶇疆").SetShared().SetValue(new Slider(0, 150, 0)));
                misc.AddItem(new MenuItem("PriorizeFarm", "琛ュ叺|浼樺厛浜巪楠氭壈").SetShared().SetValue(true));
                _config.AddSubMenu(misc);


                /* Delay sliders */
                _config.AddItem(
                    new MenuItem("ExtraWindup", "棰濆缁撴潫鏃堕棿").SetShared().SetValue(new Slider(80, 200, 0)));
                _config.AddItem(new MenuItem("FarmDelay", "琛ュ叺寤舵椂").SetShared().SetValue(new Slider(0, 200, 0)));

                /*Load the menu*/
                _config.AddItem(
                    new MenuItem("LastHit", "灏惧垁").SetShared()
                ...
                _config.AddItem(
                    new MenuItem("LaneClear", "娓呯嚎").SetShared()
