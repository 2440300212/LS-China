        ...
        internal class YasuoSharp
        {
            ...
            private static void onLoad(EventArgs args)
            {
                ...
                try
                {
                    ...
                    Config = new Menu("鐤鹃鍓戣豹", "Yasuo", true);
                    //Orbwalker
                    ...
                    Config.SubMenu("combo").AddItem(new MenuItem("comboItems", "浣跨敤 閬撳叿")).SetValue(true);
                    //SmartR
                    Config.SubMenu("combo").AddItem(new MenuItem("smartR", "鏅鸿兘 R")).SetValue(true);
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHit", "浣跨敤|R|鏁屼汉鏁皘")).SetValue(new Slider(3, 5, 1));
                    Config.SubMenu("combo").AddItem(new MenuItem("useRHitTime", "鍑婚 浣跨敤 R")).SetValue(true);
                    Config.SubMenu("combo").AddItem(new MenuItem("useEWall", "鏅鸿兘 E")).SetValue(true);
                    //Flee away
                    Config.SubMenu("combo").AddItem(new MenuItem("flee", "E 閫冭窇")).SetValue(new KeyBind('Z', KeyBindType.Press, false));
                    Config.SubMenu("combo").AddItem(new MenuItem("fleeStack", "閫冭窇 鍙犲姞 Q 鏁堟灉")).SetValue(true);
                    ...
                    Config.SubMenu("lClear").AddItem(new MenuItem("useEmpQHit", "Q|鏃嬮|灏忓叺鏁皘")).SetValue(new Slider(3, 6, 1));
                    Config.SubMenu("lClear").AddItem(new MenuItem("useElc", "浣跨敤 E")).SetValue(true);
                    //Harass
                    Config.AddSubMenu(new Menu("楠氭壈", "harass"));
                    Config.SubMenu("harass").AddItem(new MenuItem("harassTower", "濉斾笅|楠氭壈")).SetValue(false);
                    Config.SubMenu("harass").AddItem(new MenuItem("harassOn", "楠氭壈|鏁屼汉|")).SetValue(true);
                    Config.SubMenu("harass").AddItem(new MenuItem("harQ3Only", "浣跨敤 Q3")).SetValue(false);
                    //Drawings
                    Config.AddSubMenu(new Menu("鏄剧ず", "drawing"));
                    Config.SubMenu("drawing").AddItem(new MenuItem("disDraw", "鍏抽棴鏄剧ず")).SetValue(false);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawQ", "Q 鑼冨洿")).SetValue(true);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawE", "E 鑼冨洿")).SetValue(true);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawR", "R 鑼冨洿")).SetValue(true);
                    Config.SubMenu("drawing").AddItem(new MenuItem("drawWJ", "鏄剧ず 绌垮")).SetValue(true);

                    //Extra
                    Config.AddSubMenu(new Menu("鏉傞」", "extra"));
                    Config.SubMenu("extra").AddItem(new MenuItem("djTur", "涓嶈|瓒婂|")).SetValue(true);
                    ...
                    //LastHit
                    Config.AddSubMenu(new Menu("韬查伩|鎶€鑳絴", "aShots"));
                    //SmartW
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartW", "鏅鸿兘 椋庡")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("smartEDogue", "浣跨敤 E 韬查伩")).SetValue(true);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDanger", "椋庡 鍗遍櫓鎶€鑳絴")).SetValue(false);
                    Config.SubMenu("aShots").AddItem(new MenuItem("wwDmg", "椋庡 HP %")).SetValue(new Slider(0, 100, 1));
                    skillShotMenu = getSkilshotMenu();
                    Config.SubMenu("aShots").AddSubMenu(skillShotMenu);
                    //Debug
                    Config.AddSubMenu(new Menu("璋冭瘯", "debug"));
                    Config.SubMenu("debug").AddItem(new MenuItem("WWLast", "椋庡 灏侀攣")).SetValue(new KeyBind('T', KeyBindType.Press, false));
                    Config.SubMenu("debug").AddItem(new MenuItem("saveDash", "淇濆瓨 绐佽繘")).SetValue(new KeyBind('O', KeyBindType.Press, false));
                    Config.SubMenu("debug").AddItem(new MenuItem("exportDash", "绐佽繘 杈撳嚭")).SetValue(new KeyBind('P', KeyBindType.Press, false));
                    Config.SubMenu("debug").AddItem(new MenuItem("deleteDash", "鍒犻櫎 绐佽繘")).SetValue(new KeyBind('I', KeyBindType.Press, false));
