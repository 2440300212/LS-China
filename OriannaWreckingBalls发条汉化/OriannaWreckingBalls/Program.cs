...
namespace OriannaWreckingBalls
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("HarassActiveT", "鑷姩楠氭壈!").SetValue(new KeyBind("Y".ToCharArray()[0],
                        KeyBindType.Toggle)));
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("LastHitQQ", "Q灏惧垁").SetValue(new KeyBind("A".ToCharArray()[0],
                        KeyBindType.Press)));
            menu.SubMenu("Keys")
                .AddItem(
            ...
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("escape", "閫冭窇!").SetValue(new KeyBind("Z".ToCharArray()[0],
                        KeyBindType.Press)));
            //Spell Menu
            menu.AddSubMenu(new Menu("娉曟湳閫夐」", "Spell"));
            //Q Menu
            menu.SubMenu("Spell").AddSubMenu(new Menu("Q娉曟湳", "QSpell"));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qHit", "杩炴嫑Q鍛戒腑鐜").SetValue(new Slider(3, 1, 3)));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qHit2", "楠氭壈Q鍛戒腑鐜").SetValue(new Slider(3, 1, 4)));
            //W
            menu.SubMenu("Spell").AddSubMenu(new Menu("W娉曟湳", "WSpell"));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("autoW", "鑷姩W鏁屼汉鏁伴噺").SetValue(new Slider(2, 1, 5)));
            //E
            menu.SubMenu("Spell").AddSubMenu(new Menu("E娉曟湳", "ESpell"));
            menu.SubMenu("Spell").SubMenu("ESpell").AddItem(new MenuItem("UseEDmg", "鑷姩E").SetValue(true));
            menu.SubMenu("Spell").SubMenu("ESpell").AddSubMenu(new Menu("E鎶ょ浘", "shield"));
            menu.SubMenu("Spell").SubMenu("ESpell").SubMenu("shield").AddItem(new MenuItem("eAllyIfHP", "鐢熷懡 < %").SetValue(new Slider(40, 0, 100)));
            ...
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("autoR", "鑷姩R鏁屼汉鏁伴噺").SetValue(new Slider(3, 1, 5)));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("blockR", "鍋滄R").SetValue(true));
            ...
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(
                    new MenuItem("killR", "R蹇嵎").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Toggle)));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("autoRCombo", "浣跨敤R鏁屼汉鏁伴噺").SetValue(new Slider(2, 1, 5)));
            ...
            menu.SubMenu("Farm").AddItem(new MenuItem("UseWFarm", "浣跨敤 W").SetValue(false));
            menu.SubMenu("Farm").AddItem(new MenuItem("qFarm", "QW钃濋噺 >").SetValue(new Slider(3, 0, 5)));
            ...
            menu.SubMenu("Misc").AddSubMenu(new Menu("鑷姩R on", "intR"));
            ...
            menu.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("rModeDraw", "R 妯″紡").SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
            menu.SubMenu("Drawings")
